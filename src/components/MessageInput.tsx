...
export function MessageInput() {
  return (
    <div className="p-4 sticky bottom-0 bg-white">
      <div className="max-w-[90%] mx-auto shadow-xl border border-gray-200 rounded-lg p-3 bg-white">
        ...
        <p className="text-xs text-gray-500 mt-2 mb-10 text-left">
          Use XK for shortcuts
        </p>
